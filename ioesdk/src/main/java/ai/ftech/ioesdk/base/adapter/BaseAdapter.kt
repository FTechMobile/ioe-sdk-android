...
abstract class BaseAdapter : RecyclerView.Adapter<ai.ftech.ioesdk.base.adapter.BaseVH<Any>>() {
    ...
    abstract fun onCreateViewHolder(viewType: Int, view: View): ai.ftech.ioesdk.base.adapter.BaseVH<*>

    abstract fun getDataAtPosition(position: Int): Any

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ai.ftech.ioesdk.base.adapter.BaseVH<Any> {
        ...
        return onCreateViewHolder(viewType, view) as ai.ftech.ioesdk.base.adapter.BaseVH<Any>
    }
    ...
    override fun onBindViewHolder(holder: ai.ftech.ioesdk.base.adapter.BaseVH<Any>, position: Int) {
        holder.onBind(getDataAtPosition(position))
    }

    override fun onBindViewHolder(holder: ai.ftech.ioesdk.base.adapter.BaseVH<Any>, position: Int, payloads: List<Any>) {
        if (payloads.isEmpty()) {
